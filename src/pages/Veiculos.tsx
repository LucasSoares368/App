                ...
                <div className="space-y-4">
                  {manutencoesPendentes.length > 0 ? (
                    manutencoesPendentes.map((manutencao) => (
                      <div
                        key={manutencao.id}
                        className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-gray-50 dark:bg-slate-900/40 rounded-lg gap-3"
                      >
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3">
                          ...
                          <span className="text-xs md:text-sm text-gray-600 dark:text-slate-300">

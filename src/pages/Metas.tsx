...
const Metas = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "vencida":
        return "bg-red-500";
      default:
        return "bg-gray-50 dark:bg-slate-900/400";
    }
  };
  ...
  const getTipoColor = (tipo: string) => {
    switch (tipo) {
      ...
      default:
        return "bg-gray-100 text-gray-800 dark:text-slate-100";
    }
  };
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          className="w-12 h-10 border border-gray-300 dark:border-slate-700 rounded-md"
                        />
                        <div className="flex flex-wrap gap-1 max-w-xs">
                          {cores.map((cor) => (
                            <button
                              ...
                              className="w-6 h-6 rounded-full border-2 border-gray-300 dark:border-slate-700 hover:border-gray-400 transition-colors"

        ...
        <Tabs defaultValue="itens" className="w-full">
          ...
          <TabsContent value="itens" className="space-y-6">
                ...
                {stockLevels.map((level, index) => (
                  <div key={index} className="flex items-center space-x-3">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center">
                      ...
                      <span className="text-xs text-gray-600 dark:text-slate-300 md:ml-1">
                        {level.description}
                      </span>
                    </div>
                  </div>
            ...
            <Card className="p-4 md:p-6">
              <h2 className="text-lg font-bold text-gray-900 dark:text-slate-100 mb-4">Filtros</h2>
                  ...
                  <Card key={item.id} className="p-4">
                    ...
                    <div className="mt-4 space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600 dark:text-slate-300">Unidade:</span>
                        <span>{item.unidade_medida}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600 dark:text-slate-300">Quantidade:</span>
                        <span>
          ...
          <TabsContent value="categorias" className="space-y-6">
            <Card className="p-4 md:p-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                <h2 className="text-lg font-bold text-gray-900 dark:text-slate-100">Categorias</h2>
                          ...
                          <span
                            className={`px-2 py-1 text-xs rounded-full ${
                              categoria.ativa
                                ...
                                : "bg-gray-100 text-gray-800 dark:text-slate-100"
                            }`}
                          >

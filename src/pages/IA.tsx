      ...
      <div className="p-6">
        ...
        <Tabs defaultValue="upload" className="space-y-6">
          ...
          <TabsContent value="upload" className="space-y-6">
            <Card className="p-6">
              <div className="flex items-center space-x-3 mb-6">
                <FileUp className="w-5 h-5 text-gray-600 dark:text-slate-300" />
                <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100">Upload de Comprovantes</h2>
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                    {uploadedFiles.map((file) => (
                      <div key={file.id} className="border rounded-lg p-4 relative">
                        ...
                        <p className="text-xs text-gray-500 dark:text-slate-400">{file.size}</p>
                      </div>
                    ))}
                  </div>
                    ...
                    <div key={result.id} className="border rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="font-medium text-gray-900 dark:text-slate-100">{result.file_name}</span>

        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
          ...
          <Card className="p-4 md:p-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-xs md:text-sm text-gray-600 dark:text-slate-300">Receitas</p>
          ...
          <Card className="p-4 md:p-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-xs md:text-sm text-gray-600 dark:text-slate-300">Despesas</p>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {cores.map((cor) => (
                          <button
                            ...
                            className="w-6 h-6 rounded-full border-2 border-gray-300 dark:border-slate-700 hover:border-gray-400"
